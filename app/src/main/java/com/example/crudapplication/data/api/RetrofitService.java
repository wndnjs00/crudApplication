...
public class RetrofitService {
    ...
    private static String BASE_URL = "http://10.0.2.2:8080/";   // AVD(에뮬레이터)로만 테스트할때는 localhost대신 10.0.2.2   // 실제 기기로 테스트할땐 내IP주소 넣기
    ...
    // Gson 객체를 커스터마이징하여 JSON 데이터를 변환
    private static final Gson gson = new GsonBuilder()
            .registerTypeAdapter(LocalDateTime.class, new RetrofitService.LocalDateTimeDeserializer())
            .registerTypeAdapter(LocalDateTime.class, new RetrofitService.LocalDateTimeSerializer())
//            .registerTypeAdapter(LocalDate.class, new RetrofitService.LocalDateDeserializer())
//            .registerTypeAdapter(LocalDate.class, new RetrofitService.LocalDateSerializer())
            .create();
